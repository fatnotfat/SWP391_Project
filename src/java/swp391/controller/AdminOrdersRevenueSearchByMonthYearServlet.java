 ...
 * @author Admin
 */
@WebServlet(urlPatterns = {"/AdminOrdersRevenueSearchByMonthYearServlet"})
public class AdminOrdersRevenueSearchByMonthYearServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = siteMaps.getProperty(
                MyApplicationConstants.AdminOrdersRevenueSearchByMonthYearServlet.ADMIN_PAGE);
        ...
        if (session == null || session.getAttribute("USER") == null) {
            ...
            return;
                ...
                String date = request.getParameter("txtDateMonthYearRevenue");
