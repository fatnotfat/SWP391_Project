 ...
 * @author Admin
 */
@WebServlet(name = "AdminOrdersRevenueSearchByYearServlet", urlPatterns = {"/AdminOrdersRevenueSearchByYearServlet"})
public class AdminOrdersRevenueSearchByYearServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = siteMaps.getProperty(
                MyApplicationConstants.AdminOrdersRevenueSearchByYearServlet.ADMIN_PAGE);
        ...
        String dateyear = request.getParameter("txtYearRevenue");
        try {
 if (dateyear == null || dateyear.isEmpty()) {
                ...
                OrdersDAO dao2 = new OrdersDAO();
                dao2.showOrdersRevenueByYearSearch(year);
                List<OrdersDTO> result2 = dao2.getOrdersList2();
                if (result2 == null) {
                    dao2.showOrdersRevenueByYear();
                    result2 = dao2.getOrdersList2();
                    request.setAttribute("YEARREVENUE_RESULT", result2);
