...
public class AdminUpdateBrandServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String txtBrandID = request.getParameter("brandIdUpdate");
        System.out.println("BrandID" + txtBrandID);
       ...
       String statusParam = request.getParameter("status");
        ...
        try {
            ...
            boolean result = dao.updateBrand(brandID, name, description, status);
            if (result) {
