                        ...
                        if (data.length > 0) {
                            for (var i = 0; i < data.length; i++) {
                                ...
                                html += '<div class="grid__column-3-4">'
                                        ...
                                        + '<div  class="card">'
                                        + '<img  class="img-back" src="${pageContext.request.contextPath}/images/Store/' + data[i].avatar + '" alt="Card Back">'
                                        + '<img class="img-top"  src="${pageContext.request.contextPath}/images/Store/' + data[i].avatar2 + '" alt="Card Front">'
                                        + '</div>'
                                        + '</div>'
                                    ...
                                    <ul class="category__filter-include">
                                        Category <select name="txtProductCateID" id="categorySelect">
                                            <c:forEach var="cateDTO" items="${sessionScope.CATEGORY_LIST}" >
                                                <option value="${cateDTO.cateID}" ${param.txtProductCateID == cateDTO.cateID ? 'selected' : ''}>${fn:toUpperCase(cateDTO.name)}</option>
                                            </c:forEach>
