function showDelete(categoryID){
    document.getElementById("categoryIdDelete").value = categoryID;
        console.log(document.getElementById("categoryIdDelete").value); 
...
function showEdit(categoryID, name, description, status){
    
     document.getElementById("categoryIdUpdate").value = categoryID;
    console.log( document.getElementById("categoryIdUpdate").value)
